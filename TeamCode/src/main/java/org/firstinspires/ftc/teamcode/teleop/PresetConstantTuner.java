...
public class PresetConstantTuner extends OpMode {
    ...
    public static double CLAW_X_1 = 0;
    ...
    public void init() {
        components = new Component[]{
                ...
                new StepperServo(0, "clawXServo1", hardwareMap),      //2
                new StepperServo(1, "clawXServo2", hardwareMap),      //3
...
//        claw.clawX2.setAngle((float) CLAW_X_2*180);
        ...
        telemetry.addData("claw x1 target", CLAW_X_1);
        telemetry.addData("claw x1", claw.clawX1.servo.getPosition());
        telemetry.addData("claw x2 target", CLAW_X_2);
        telemetry.addData("claw x2", claw.clawX2.servo.getPosition());
